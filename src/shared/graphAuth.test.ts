...
describe('DEFAULT_SCOPE', () => {
  it('covers mail, mail-write (drafts), calendar, and offline refresh', () => {
    expect(DEFAULT_SCOPE).toContain('Mail.Read');
    expect(DEFAULT_SCOPE).toContain('Mail.ReadWrite');
    expect(DEFAULT_SCOPE).toContain('Calendars.Read');
    expect(DEFAULT_SCOPE).toContain('offline_access');
  });
});
