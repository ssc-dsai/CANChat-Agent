// Pure helpers for the Microsoft Graph OAuth (auth-code + PKCE) flow used to read
// the user's mailbox. URL/body/PKCE construction lives here (no chrome.*/network)
// so it is unit-testable; the interactive launch + token storage live in
// background/graphAuth.ts.

const AUTHORITY = 'https://login.microsoftonline.com';
/** Delegated scopes: read mail, plus a refresh token for silent re-auth. */
export const DEFAULT_SCOPE = 'Mail.Read offline_access openid';
