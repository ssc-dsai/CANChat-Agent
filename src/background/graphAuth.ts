// =============================================================================
// Microsoft Graph OAuth (auth-code + PKCE) for the mailbox indexer. Runs in the
// service worker: launches the interactive sign-in via chrome.identity, exchanges
// the code for tokens, and refreshes silently. Tokens live in chrome.storage.local
// (same trust level as the configured API key). Pure URL/PKCE construction is in
// shared/graphAuth.ts. No client secret — this is a public PKCE client.
// =============================================================================
