...
const EN: Dict = {
  ...
  'mail.hint': 'Connect with Microsoft (Graph) and index your mail on-device. Re-run to add only new messages.',
  'mail.index': 'Connect & index mailbox',
  'mail.working': '📧 Indexing mailbox…',
  'mail.disconnect': 'Disconnect',
  'mail.starting': 'Connecting to Microsoft…',
  ...
  'mail.disconnected': 'Mailbox disconnected.',
  'mail.needClientId': 'To index your mailbox, set an Azure app Client ID in Settings → Advanced.',
  ...
  'data.open.failed': 'Could not open the data file: {error}.',
  ...
  'settings.graphClientId': 'Mailbox: Azure app Client ID (optional)',
  'settings.graphTenant': 'Mailbox: Azure tenant (optional)',
  'settings.graphNote':
    'To index your Office 365 mailbox, register an Azure AD app with the Mail.Read delegated permission, set its redirect URI to https://<extension-id>.chromiumapp.org/, and paste its Client ID here. Tenant defaults to "organizations". Most enterprise tenants require admin consent.',
...
const FR: Dict = {
  ...
  'mail.hint': 'Connectez-vous avec Microsoft (Graph) et indexez vos courriels sur l’appareil. Relancez pour n’ajouter que les nouveaux messages.',
  'mail.index': 'Connecter et indexer la boîte',
  'mail.working': '📧 Indexation de la boîte…',
  'mail.disconnect': 'Déconnecter',
  'mail.starting': 'Connexion à Microsoft…',
  ...
  'mail.disconnected': 'Boîte déconnectée.',
  'mail.needClientId': 'Pour indexer votre boîte, renseignez un Client ID d’application Azure dans Paramètres → Avancé.',
  ...
  'data.open.done': 'Chargé dans le moteur de données : {tables}. Posez une question pour l’interroger.',
  'data.open.failed': 'Impossible d’ouvrir le fichier de données : {error}.',
  ...
  'settings.graphClientId': 'Boîte : Client ID d’application Azure (facultatif)',
  'settings.graphTenant': 'Boîte : locataire Azure (facultatif)',
  'settings.graphNote':
    'Pour indexer votre boîte Office 365, enregistrez une application Azure AD avec la permission déléguée Mail.Read, définissez son URI de redirection à https://<extension-id>.chromiumapp.org/, puis collez son Client ID ici. Le locataire par défaut est « organizations ». La plupart des locataires d’entreprise exigent le consentement d’un administrateur.',
