...
const EN: Dict = {
  ...
  'repos.upload.dropHint': 'Drop files here, or click to choose (PDF, Word, PowerPoint, Excel, text).',
  'repos.upload.note':
  ...
  'repos.upload.working': 'Adding files…',
  'repos.upload.add': 'Add',
  'repos.upload.addN': 'Add {n} file(s) to:',
  'repos.upload.added': 'Added {n} file(s) ({c} chunks).',
  'repos.upload.skipped': 'Skipped: {items}.',
  // status
  'status.idle': 'Idle',
...
const FR: Dict = {
  ...
  'repos.upload.dropHint': 'Déposez des fichiers ici, ou cliquez pour choisir (PDF, Word, PowerPoint, Excel, texte).',
  'repos.upload.note':
  ...
  'repos.upload.working': 'Ajout des fichiers…',
  'repos.upload.add': 'Ajouter',
  'repos.upload.addN': 'Ajouter {n} fichier(s) à :',
  'repos.upload.added': '{n} fichier(s) ajouté(s) ({c} segments).',
  'repos.upload.skipped': 'Ignorés : {items}.',
  // status
  'status.idle': 'Inactif',
